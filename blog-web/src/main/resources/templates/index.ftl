            ...
            <div class="scrolltext">
                <ul class="list-unstyled" id="notice-box">
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">本站正式启用新域名:<a href="https:/www.zhyd.me" target="_blank"><strong>http://15862518424.gnway.cc/siteurl/</strong></a></a>
                    </li>
                    <li class="scrolltext-title">
         ...
         <#--   <div class="blog-body expansion" style="padding: 0;margin-bottom: 0;border-bottom: 1px solid #eeeeee;">
            ...
            <#else >
                <article class="fade-in" style="height: auto">
                    ...
                    <form action="${config.staticWebSite}/" method="post" class="form-horizontal searchForm">
